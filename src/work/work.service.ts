...
import { IGatherersWorkReport, IScavengersWorkReports, IWorkReport } from './work.interfaces';
...
export class WorkService {
  ...
  async startColonieWork(memberDiscordId: string): Promise<IWorkReport> {
    const context = {
      ...
      resources: await this.resourceService.getResourcesForMember(memberDiscordId),
    };
    return {
